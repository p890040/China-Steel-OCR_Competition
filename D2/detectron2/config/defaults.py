...
_C.MODEL.ANGLE_ON = False
_C.MODEL.MASKPOINT_ON = False
_C.MODEL.BMASK_ON = False
...
#Pawn
_C.INPUT.IS_ABSOLUTE_SIZE=False
_C.INPUT.HEIGHT = 180
_C.INPUT.WIDTH = 180
...
# ER AREA
_C.DATASETS.TRAIN_ER = ""

# =============================================================================
# ADD BY BRILIAN
_C.TRAINAUG = CN()
_C.TRAINAUG.DOCOLORJITTER = ''
_C.TRAINAUG.DOHISTOGRAM = ''
_C.TRAINAUG.DORESIZELOW = ''
_C.TRAINAUG.DOFLIP = ''
_C.TRAINAUG.DOROTATE = ''
_C.TRAINAUG.DONOISE = ''
_C.TRAINAUG.DOSHIFT = ''
_C.TRAINAUG.DOZOOM = ''
_C.TRAINAUG.USE_SOLTRANSFORM = False
_C.TRAINAUG.USE_KEYPOINTS = False  # counter, used in soltransform with keypoints
_C.TRAINAUG.OMIT_OOB = 0.05  # counter, used in soltransform with keypoints
# =============================================================================
...
# Pawn
_C.MODEL.RPN.relative_bg = False
...
# Pawn
_C.MODEL.ROI_HEADS.relative_bg = False
...
# Angle Head
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_ANGLE_HEAD = CN()
# C4 don't use head name option
# Options for non-C4 models: FastRCNNConvFCHead,
_C.MODEL.ROI_ANGLE_HEAD.NAME = "FastRCNNConvFCHead"
_C.MODEL.ROI_ANGLE_HEAD.NUM_FC = 1
# Hidden layer dimension for FC layers in the RoI box head
_C.MODEL.ROI_ANGLE_HEAD.FC_DIM = 72
_C.MODEL.ROI_ANGLE_HEAD.NUM_CONV = 0
# Channel dimension for Conv layers in the RoI box head
_C.MODEL.ROI_ANGLE_HEAD.CONV_DIM = 256
# Normalization method for the convolution layers.
# Options: "" (no norm), "GN", "SyncBN".
_C.MODEL.ROI_ANGLE_HEAD.NORM = ""
# Whether to use class agnostic for bbox regression
_C.MODEL.ROI_ANGLE_HEAD.CLS_AGNOSTIC_BBOX_REG = False
# If true, RoI heads use bounding boxes predicted by the box head rather than proposal boxes.
_C.MODEL.ROI_ANGLE_HEAD.TRAIN_ON_PRED_BOXES = False
...
# ---------------------------------------------------------------------------- #
# Boundary Mask Head By Pawn
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_BMASK_HEAD = CN()
_C.MODEL.ROI_BMASK_HEAD.NAME = "BoundaryPreservingHead"
_C.MODEL.ROI_BMASK_HEAD.POOLER_RESOLUTION = 28
_C.MODEL.ROI_BMASK_HEAD.IN_FEATURES = ("p2",)
_C.MODEL.ROI_BMASK_HEAD.NUM_CONV = 2


# ---------------------------------------------------------------------------- #
# Mask Scroing Head By Pawn
# ---------------------------------------------------------------------------- #
...
_C.MODEL.ROI_MASKIOU_HEAD.MASKIOU_LOSS_WEIGHT = 1.0
...
# ---------------------------------------------------------------------------- #
# MaskPoint Head By Pawn
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_MASKPOINT_HEAD = CN()
_C.MODEL.ROI_MASKPOINT_HEAD.NAME = "MaskPointRCNNConvDeconvUpsampleHead"
_C.MODEL.ROI_MASKPOINT_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_MASKPOINT_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_MASKPOINT_HEAD.CONV_DIMS = tuple(512 for _ in range(8))
_C.MODEL.ROI_MASKPOINT_HEAD.NUM_KEYPOINTS = 100
_C.MODEL.ROI_MASKPOINT_HEAD.MIN_KEYPOINTS_PER_IMAGE = 1
_C.MODEL.ROI_MASKPOINT_HEAD.NORMALIZE_LOSS_BY_VISIBLE_KEYPOINTS = True
_C.MODEL.ROI_MASKPOINT_HEAD.LOSS_WEIGHT = 0.5
_C.MODEL.ROI_MASKPOINT_HEAD.POOLER_TYPE = "ROIAlignV2"
...
# Pawn
_C.MODEL.ITERDET_ON = False
_C.MODEL.ITERDET = CN()
_C.MODEL.ITERDET.ITER = 2
