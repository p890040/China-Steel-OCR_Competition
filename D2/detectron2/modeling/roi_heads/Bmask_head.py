...
ROI_BMASK_HEAD_REGISTRY = Registry("ROI_BMASK_HEAD")
ROI_BMASK_HEAD_REGISTRY.__doc__ = """
...
@ROI_BMASK_HEAD_REGISTRY.register()
class BoundaryPreservingHead(nn.Module):
    ...
    def __init__(self, cfg, input_shape: ShapeSpec):
        ...
        num_boundary_conv = cfg.MODEL.ROI_BMASK_HEAD.NUM_CONV
...
def build_Bmask_head(cfg, input_shape):
    """
    Build a mask head defined by `cfg.MODEL.ROI_MASK_HEAD.NAME`.
    """
    name = cfg.MODEL.ROI_BMASK_HEAD.NAME
    return ROI_BMASK_HEAD_REGISTRY.get(name)(cfg, input_shape)
