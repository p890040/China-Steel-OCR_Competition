...
class RPN(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.anchor_matcher = Matcher(
            cfg.MODEL.RPN.IOU_THRESHOLDS, cfg.MODEL.RPN.IOU_LABELS, allow_low_quality_matches=True, relative_bg=cfg.MODEL.RPN.relative_bg, relative_bg_value=cfg.MODEL.RPN.relative_bg_value
        )# Pawn
