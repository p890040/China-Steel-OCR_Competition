...
#    DatasetCatalog.register(name, lambda: load_coco_json(json_file, image_root, name))
    DatasetCatalog.register(name, lambda: load_coco_json(json_file, image_root, name, extra_annotation_keys=['angle','maskpoints'])) #Pawn temp
...
def register_semantic(name, metadata, image_root, sem_seg_root): #Pawn temp
    """
    Register a COCO panoptic segmentation dataset named `name`.
    The annotations in this registered dataset will contain both instance annotations and
    semantic annotations, each with its own contiguous ids. Hence it's called "separated".
